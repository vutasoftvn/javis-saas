...
description: Tính toán quy mô thị trường tổng thể (TAM), thị trường phục vụ được (SAM)
  và thị trường mục tiêu đạt được (SOM) từ dữ liệu thực nghiệm.
---

# TAM SAM SOM Market Sizing

## Mục đích & Giới hạn Quyền hạn
Tính toán quy mô thị trường tổng thể (TAM), thị trường phục vụ được (SAM) và thị trường mục tiêu đạt được (SOM) từ dữ liệu thực nghiệm.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `research.market-sizing` trong giai đoạn P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/research/market-sizing.yaml`
