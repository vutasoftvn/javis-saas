...
description: Khảo sát xu hướng ngành, báo cáo thị trường và các tín hiệu công nghệ
  mới hỗ trợ luận điểm khám phá.
---

# Industry Trends & Market Signals Scan

## Mục đích & Giới hạn Quyền hạn
Khảo sát xu hướng ngành, báo cáo thị trường và các tín hiệu công nghệ mới hỗ trợ luận điểm khám phá.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `research.industry-trends` trong giai đoạn P0_DISCOVERY.
...
## Eval Notes
- Suite: `evals/research/industry-trends.yaml`
