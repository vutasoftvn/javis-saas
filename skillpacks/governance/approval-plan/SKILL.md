---
name: governance-approval-plan
description: Xây dựng kế hoạch phê duyệt phân tầng (founder, co-founder, admin) cho
  các quyết định chuyển stage và chi tiêu.
---

# Governance Approval Plan Builder

## Mục đích & Giới hạn Quyền hạn
Xây dựng kế hoạch phê duyệt phân tầng (founder, co-founder, admin) cho các quyết định chuyển stage và chi tiêu.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `governance.approval-plan` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/governance/approval-plan.yaml`
