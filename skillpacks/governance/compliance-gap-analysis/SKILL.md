---
name: governance-compliance-gap-analysis
description: Rà soát khoảng trống tuân thủ quy định ngành và chính sách bảo mật trước
  khi thương mại hóa.
---

# Regulatory & Policy Compliance Gap Analysis

## Mục đích & Giới hạn Quyền hạn
Rà soát khoảng trống tuân thủ quy định ngành và chính sách bảo mật trước khi thương mại hóa.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `governance.compliance-gap-analysis` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/governance/compliance-gap-analysis.yaml`
