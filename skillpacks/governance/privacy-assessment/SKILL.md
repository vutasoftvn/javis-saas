---
name: governance-privacy-assessment
description: Đánh giá tuân thủ quyền riêng tư, ranh giới tenant, bảo vệ dữ liệu PII
  và phân loại dữ liệu khách hàng.
---

# Privacy Impact & Data Governance Assessment

## Mục đích & Giới hạn Quyền hạn
Đánh giá tuân thủ quyền riêng tư, ranh giới tenant, bảo vệ dữ liệu PII và phân loại dữ liệu khách hàng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `governance.privacy-assessment` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/governance/privacy-assessment.yaml`
