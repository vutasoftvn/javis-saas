---
name: governance-security-assessment
description: Đánh giá mức độ an toàn thông tin, rủi ro cấu hình, ủy quyền phân quyền
  RBAC và ranh giới multi-tenant.
---

# Security Posture & Vulnerability Review

## Mục đích & Giới hạn Quyền hạn
Đánh giá mức độ an toàn thông tin, rủi ro cấu hình, ủy quyền phân quyền RBAC và ranh giới multi-tenant.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `governance.security-assessment` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/governance/security-assessment.yaml`
