---
name: governance-policy-resolution
description: Tra cứu và giải quyết các điều kiện tiên quyết của chính sách cổng kiểm
  soát cho từng dự án.
---

# Stage Policy Resolution Engine

## Mục đích & Giới hạn Quyền hạn
Tra cứu và giải quyết các điều kiện tiên quyết của chính sách cổng kiểm soát cho từng dự án.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `governance.policy-resolution` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/governance/policy-resolution.yaml`
