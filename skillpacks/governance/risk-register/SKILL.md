---
name: governance-risk-register
description: Lập và theo dõi sổ đăng ký rủi ro dự án (thị trường, kỹ thuật, pháp lý,
  tài chính) kèm kế hoạch giảm thiểu.
---

# Venture Risk Register & Mitigation Log

## Mục đích & Giới hạn Quyền hạn
Lập và theo dõi sổ đăng ký rủi ro dự án (thị trường, kỹ thuật, pháp lý, tài chính) kèm kế hoạch giảm thiểu.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `governance.risk-register` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/governance/risk-register.yaml`
