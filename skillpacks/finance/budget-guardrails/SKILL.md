---
name: finance-budget-guardrails
description: Thiết lập hàng rào ngân sách kiểm soát chi phí thực nghiệm và chi tiêu
  giai đoạn sớm.
---

# Budget Guardrails & Spending Policy

## Mục đích & Giới hạn Quyền hạn
Thiết lập hàng rào ngân sách kiểm soát chi phí thực nghiệm và chi tiêu giai đoạn sớm.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `finance.budget-guardrails` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/finance/budget-guardrails.yaml`
