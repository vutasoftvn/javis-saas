---
name: sales-founder-led-sales-copilot
description: Hỗ trợ founder chuẩn bị cuộc gọi bán hàng sớm, xử lý từ chối và ghi nhận
  nhu cầu thực tế.
---

# Founder-Led Sales Copilot & Call Preparation

## Mục đích & Giới hạn Quyền hạn
Hỗ trợ founder chuẩn bị cuộc gọi bán hàng sớm, xử lý từ chối và ghi nhận nhu cầu thực tế.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `sales.founder-led-sales-copilot` trong giai đoạn P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/sales/founder-led-sales-copilot.yaml`
