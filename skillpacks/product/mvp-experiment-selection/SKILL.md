---
name: product-mvp-experiment-selection
description: Lựa chọn loại hình thực nghiệm kiểm chứng giải pháp chi phí thấp nhất
  (Concierge, Wizard of Oz, Smoke Test, Prototype).
---

# Low-Cost Experiment Selection Guide

## Mục đích & Giới hạn Quyền hạn
Lựa chọn loại hình thực nghiệm kiểm chứng giải pháp chi phí thấp nhất (Concierge, Wizard of Oz, Smoke Test, Prototype).
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `product.mvp-experiment-selection` trong giai đoạn P2_SOLUTION_VALIDATION.
...
## Eval Notes
- Suite: `evals/product/mvp-experiment-selection.yaml`
