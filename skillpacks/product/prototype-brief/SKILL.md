---
name: product-prototype-brief
description: Soạn thảo tài liệu yêu cầu cho prototype kiểm chứng tương tác người dùng.
---

# Interactive Prototype Specification Brief

## Mục đích & Giới hạn Quyền hạn
Soạn thảo tài liệu yêu cầu cho prototype kiểm chứng tương tác người dùng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `product.prototype-brief` trong giai đoạn P2_SOLUTION_VALIDATION.
...
## Eval Notes
- Suite: `evals/product/prototype-brief.yaml`
