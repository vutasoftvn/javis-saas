---
name: product-mvp-prioritization
description: Thu gọn phạm vi MVP tối thiểu để kiểm chứng giải pháp, cắt bỏ tính năng
  không thiết yếu.
---

# MVP Feature Scope & MoSCoW Prioritization

## Mục đích & Giới hạn Quyền hạn
Thu gọn phạm vi MVP tối thiểu để kiểm chứng giải pháp, cắt bỏ tính năng không thiết yếu.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `product.mvp-prioritization` trong giai đoạn P2_SOLUTION_VALIDATION.
...
## Eval Notes
- Suite: `evals/product/mvp-prioritization.yaml`
