---
name: product-core-workflow-map
description: Vẽ luồng trải nghiệm người dùng cốt lõi (happy path) và các điểm ma sát
  tiềm ẩn của giải pháp.
---

# Core User Workflow & Experience Journey

## Mục đích & Giới hạn Quyền hạn
Vẽ luồng trải nghiệm người dùng cốt lõi (happy path) và các điểm ma sát tiềm ẩn của giải pháp.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `product.core-workflow-map` trong giai đoạn P2_SOLUTION_VALIDATION.
...
## Eval Notes
- Suite: `evals/product/core-workflow-map.yaml`
