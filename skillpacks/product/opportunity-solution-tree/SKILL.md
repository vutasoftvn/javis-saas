---
name: product-opportunity-solution-tree
description: Xây dựng cây cơ hội - giải pháp (Teresa Torres) nối từ mục tiêu mong
  muốn đến các giải pháp và thực nghiệm kiểm chứng.
---

# Opportunity Solution Tree Mapping

## Mục đích & Giới hạn Quyền hạn
Xây dựng cây cơ hội - giải pháp (Teresa Torres) nối từ mục tiêu mong muốn đến các giải pháp và thực nghiệm kiểm chứng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `product.opportunity-solution-tree` trong giai đoạn P2_SOLUTION_VALIDATION.
...
## Eval Notes
- Suite: `evals/product/opportunity-solution-tree.yaml`
