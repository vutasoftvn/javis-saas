...
description: Định hình chiến lược kênh tiếp cận khách hàng giai đoạn đầu (Outbound,
  Content, Community, Partnerships).
---

# Early Customer Acquisition Channel Strategy

## Mục đích & Giới hạn Quyền hạn
Định hình chiến lược kênh tiếp cận khách hàng giai đoạn đầu (Outbound, Content, Community, Partnerships).
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `marketing.channel-strategy` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/marketing/channel-strategy.yaml`
