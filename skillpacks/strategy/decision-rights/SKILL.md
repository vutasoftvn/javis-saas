---
name: strategy-decision-rights
description: Xác lập ma trận quyền quyết định giữa các đồng sáng lập và hội đồng quản
  trị cho các cột mốc quan trọng.
---

# Decision Rights & Governance Matrix (DACI/RACI)

## Mục đích & Giới hạn Quyền hạn
Xác lập ma trận quyền quyết định giữa các đồng sáng lập và hội đồng quản trị cho các cột mốc quan trọng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `strategy.decision-rights` trong giai đoạn P0_DISCOVERY.
...
## Eval Notes
- Suite: `evals/strategy/decision-rights.yaml`
