---
name: strategy-icp-definition
description: Xác lập chân dung khách hàng lý tưởng (ICP) chi tiết dựa trên các bằng
  chứng phỏng vấn và dữ liệu khách hàng.
---

# Ideal Customer Profile & Problem Fit

## Mục đích & Giới hạn Quyền hạn
Xác lập chân dung khách hàng lý tưởng (ICP) chi tiết dựa trên các bằng chứng phỏng vấn và dữ liệu khách hàng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `strategy.icp-definition` trong giai đoạn P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/strategy/icp-definition.yaml`
