---
name: strategy-venture-thesis
description: Soạn thảo và chuẩn hóa luận điểm khởi nghiệp (venture thesis), định vị
  cơ hội thị trường và tiền đề cốt lõi.
---

# Venture Thesis & Problem Discovery Formulation

## Mục đích & Giới hạn Quyền hạn
Soạn thảo và chuẩn hóa luận điểm khởi nghiệp (venture thesis), định vị cơ hội thị trường và tiền đề cốt lõi.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `strategy.venture-thesis` trong giai đoạn P0_DISCOVERY.
...
## Eval Notes
- Suite: `evals/strategy/venture-thesis.yaml`
