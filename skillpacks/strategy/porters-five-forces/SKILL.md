...
description: Phân tích 5 áp lực cạnh tranh của Porter đối với thị trường mục tiêu
  của dự án.
---
...
Phân tích 5 áp lực cạnh tranh của Porter đối với thị trường mục tiêu của dự án.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `strategy.porters-five-forces` trong giai đoạn P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/strategy/porters-five-forces.yaml`
