---
name: strategy-value-proposition
description: Khớp nối giải pháp sản phẩm với các nỗi đau và lợi ích đã được kiểm chứng
  của khách hàng.
---

# Value Proposition Canvas & Solution Fit

## Mục đích & Giới hạn Quyền hạn
Khớp nối giải pháp sản phẩm với các nỗi đau và lợi ích đã được kiểm chứng của khách hàng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `strategy.value-proposition` trong giai đoạn P2_SOLUTION_VALIDATION.
...
## Eval Notes
- Suite: `evals/strategy/value-proposition.yaml`
