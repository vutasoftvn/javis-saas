---
name: analytics-metric-contract
description: Định nghĩa hợp đồng chỉ số (metric contract), công thức tính toán và
  nguồn dữ liệu tin cậy cho dự án.
---

# Metric Contract & KPI Definition

## Mục đích & Giới hạn Quyền hạn
Định nghĩa hợp đồng chỉ số (metric contract), công thức tính toán và nguồn dữ liệu tin cậy cho dự án.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `analytics.metric-contract` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/analytics/metric-contract.yaml`
