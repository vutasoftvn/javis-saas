---
name: evidence-intake-provenance
description: Ghi nhận bằng chứng mới vào hệ thống dưới trạng thái candidate, lưu vết
  nguồn gốc (provenance) và liên kết artifact.
---

# Evidence Ingestion & Provenance Logger

## Mục đích & Giới hạn Quyền hạn
Ghi nhận bằng chứng mới vào hệ thống dưới trạng thái candidate, lưu vết nguồn gốc (provenance) và liên kết artifact.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `evidence.intake-provenance` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/evidence/intake-provenance.yaml`
