...
description: Phân tích các lỗ hổng bằng chứng còn thiếu đối chiếu với yêu cầu của
  gate giai đoạn hiện tại.
---

# Evidence Gap Analysis & Deficiency Audit

## Mục đích & Giới hạn Quyền hạn
Phân tích các lỗ hổng bằng chứng còn thiếu đối chiếu với yêu cầu của gate giai đoạn hiện tại.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `evidence.gap-analysis` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/evidence/gap-analysis.yaml`
