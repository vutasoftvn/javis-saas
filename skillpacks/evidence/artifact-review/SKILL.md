---
name: evidence-artifact-review
description: Đánh giá chất lượng và độ xác thực của các artifact dự án trước khi đệ
  trình duyệt làm bằng chứng chính thức.
---

# Artifact Quality & Evidence Review

## Mục đích & Giới hạn Quyền hạn
Đánh giá chất lượng và độ xác thực của các artifact dự án trước khi đệ trình duyệt làm bằng chứng chính thức.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `evidence.artifact-review` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/evidence/artifact-review.yaml`
