---
name: discovery-interview-script
description: Tạo kịch bản phỏng vấn khách hàng không thiên kiến tuân thủ The Mom Test
  và JTBD.
---

# Customer Discovery Interview Script Generator

## Mục đích & Giới hạn Quyền hạn
Tạo kịch bản phỏng vấn khách hàng không thiên kiến tuân thủ The Mom Test và JTBD.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `discovery.interview-script` trong giai đoạn P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/discovery/interview-script.yaml`
