...
description: Chuẩn bị hồ sơ bối cảnh và mục tiêu kiểm chứng trước buổi phỏng vấn khách
  hàng.
---

# Discovery Interview Brief & Subject Background

## Mục đích & Giới hạn Quyền hạn
Chuẩn bị hồ sơ bối cảnh và mục tiêu kiểm chứng trước buổi phỏng vấn khách hàng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `discovery.interview-prep` trong giai đoạn P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/discovery/interview-prep.yaml`
