---
name: discovery-pain-point-analysis
description: Phân loại và xếp hạng mức độ nghiêm trọng cũng như tần suất của các nỗi
  đau khách hàng.
---

# Customer Pain Point Severity Ranking

## Mục đích & Giới hạn Quyền hạn
Phân loại và xếp hạng mức độ nghiêm trọng cũng như tần suất của các nỗi đau khách hàng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `discovery.pain-point-analysis` trong giai đoạn P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/discovery/pain-point-analysis.yaml`
