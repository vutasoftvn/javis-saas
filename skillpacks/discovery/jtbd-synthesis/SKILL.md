---
name: discovery-jtbd-synthesis
description: Tổng hợp các nhiệm vụ cần hoàn thành (JTBD), kết quả mong đợi và lực
  cản chuyển đổi từ phỏng vấn.
---

# Jobs-To-Be-Done & Outcome Synthesis

## Mục đích & Giới hạn Quyền hạn
Tổng hợp các nhiệm vụ cần hoàn thành (JTBD), kết quả mong đợi và lực cản chuyển đổi từ phỏng vấn.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `discovery.jtbd-synthesis` trong giai đoạn P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/discovery/jtbd-synthesis.yaml`
