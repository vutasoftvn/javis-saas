---
name: ai-model-provider-risk
description: Đánh giá rủi ro phụ thuộc vào nhà cung cấp mô hình nền tảng, độ trễ,
  chi phí token và tính sẵn sàng chuyển đổi.
---

# Foundation Model Provider Risk & Dependency Review

## Mục đích & Giới hạn Quyền hạn
Đánh giá rủi ro phụ thuộc vào nhà cung cấp mô hình nền tảng, độ trễ, chi phí token và tính sẵn sàng chuyển đổi.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `ai.model-provider-risk` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION.
...
## Eval Notes
- Suite: `evals/ai/model-provider-risk.yaml`
