---
name: lifecycle-context-resolver
description: Truy xuất và chuẩn hóa ngữ cảnh giai đoạn vòng đời dự án (P0-P6), gate
  policies và tiêu chuẩn bằng chứng.
---

# Lifecycle Stage Context Resolver

## Mục đích & Giới hạn Quyền hạn
Truy xuất và chuẩn hóa ngữ cảnh giai đoạn vòng đời dự án (P0-P6), gate policies và tiêu chuẩn bằng chứng.
...
## Triggers
- Kích hoạt khi cần thực hiện nghiệp vụ `lifecycle.context-resolver` trong giai đoạn P0_DISCOVERY, P1_PROBLEM_VALIDATION, P2_SOLUTION_VALIDATION, P3_BUILD_VALIDATE, P4_GO_TO_MARKET, P5_OPERATE_GROWTH, P6_SCALE_GOVERN.
...
## Eval Notes
- Suite: `evals/lifecycle/context-resolver.yaml`
