...
from apps.cosa.capabilities.people_risk_read import create_people_risk_read_handler
...
_CANNED_SNAPSHOT = {
    ...
    "candidateName": "should never leak",
    "compensation": {"secret": "should never leak"},
}
...
async def test_handler_uses_ctx_project_and_workspace_scope_with_real_dict_ctx() -> None:
    ...
    assert call["path"] == "/operations/projects/project-A/people-risk-dossier"
