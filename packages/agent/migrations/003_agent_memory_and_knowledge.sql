...
-- Storage ownership: agent_memory owned by packages/agent/memory; knowledge owned by packages/agent/knowledge.

-- Enable pgvector extension (idempotent)
CREATE EXTENSION IF NOT EXISTS vector;

-- ============================================================================
-- SCHEMA: agent_memory (Owned by packages/agent/memory)
-- ============================================================================
...
-- ============================================================================
-- SCHEMA: knowledge (Owned by packages/agent/knowledge)
-- ============================================================================
