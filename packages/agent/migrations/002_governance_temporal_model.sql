...
--   see COSA_AGENT_GOVERNANCE_TEMPORAL_MODEL_2026-08-23.md.
...
CREATE INDEX IF NOT EXISTS idx_spec_resolution_manifest_run_id
    ON agent_governance.spec_resolution_manifest_entries(run_id);
...
CREATE INDEX IF NOT EXISTS idx_invocation_governance_history_invocation
    ON agent_governance.invocation_governance_history(run_id, tool_call_id, observed_at);
...
CREATE INDEX IF NOT EXISTS idx_approval_evidence_scope
    ON agent_governance.approval_evidence(scope);
