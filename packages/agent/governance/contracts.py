...
class PinnedSpecIdentity(BaseModel):
    ...
    COSA_AGENT_GOVERNANCE_TEMPORAL_MODEL_2026-08-23.md và ADR-ARTIFACT-IDENTITY-001
    ...
    SpecResolutionManifest/agent_governance.spec_resolution_manifest_entries
