...
from founder_os.strategy.project_classifier_service import ProjectClassifierService
from founder_os.strategy.methodology_router import MethodologyRouterService
from founder_os.strategy.assisted_analyzer import AssistedAnalyzerService
...
from founder_os.strategy.schemas import (
    ObjectiveCreate,
    CanvasCreate,
    CanvasUpdate,
    RevisionCreate,
...
from founder_os.strategy.routers.analysis_router import (
    router as analysis_router,
    create_decision,
    list_decisions,
    _serialize_decision,
)
from founder_os.strategy.routers.project_orchestration_router import router as project_orchestration_router
from founder_os.strategy.routers.template_router import router as template_router

router = APIRouter()

from founder_os.strategy.routers.stage_foundation_router import router as stage_foundation_router
from founder_os.strategy.routers.evidence_router import router as evidence_router
from founder_os.strategy.routers.strategy_lens_router import router as strategy_lens_router
from founder_os.strategy.routers.stage_gate_router import router as stage_gate_router
from founder_os.strategy.routers.twelve_wy_router import router as twelve_wy_router
