...
from workforce.ai_team.service import get_function_statuses
...
class ReviewAndTransitionService:
    ...
    def _build_review_composition(self, cycle_id: int, week_no: Optional[int] = None) -> Dict[str, Any]:
    ...
    def _serialize_weekly_review(self, r: WeeklyReview) -> Dict[str, Any]:
        ...
        result.update(self._build_review_composition(r.cycle_id, r.week_no))
        return result
    ...
    def _serialize_cycle_review(self, cr: CycleReview) -> Dict[str, Any]:
        ...
        result.update(self._build_review_composition(cr.cycle_id))
        return result
    ...
    def _serialize_celebration(self, c: CelebrationRecord) -> Dict[str, Any]:
        ...
        result.update(self._build_review_composition(c.cycle_id))
        return result
