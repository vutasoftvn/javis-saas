...
from core.tenancy import resolve_workflow_run_workspace_id
from core.audit import write_audit_log
from db.models import WorkspaceMember, WorkflowDefinition, WorkflowVersion, WorkflowRun, WorkflowStep, WorkflowApproval, Brain
...
def create_workflow_definition(
    ...
    from workforce.agents.runtime.execution_scope import ScopeRequest, ScopeResolutionError
    from workforce.agents.runtime.scope_resolver import resolve_execution_scope
...
from integrations.workflows.n8n_gateway_service import handle_n8n_callback
