...
from integrations.channels.outbox.channel_worker import process_telegram_bot
...
async def test_telegram_worker_denies_messages_without_an_allowlist(monkeypatch):
    ...
    monkeypatch.setattr("integrations.channels.outbox.channel_worker._generate_ai_reply", lambda _: "reply")
