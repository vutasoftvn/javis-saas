...
from platform_core.reports.service import ReportService
...
def test_create_and_trigger_report_flow():
    ...
    with patch("platform_core.reports.service.ProgressSnapshotService.generate_snapshot", return_value={
