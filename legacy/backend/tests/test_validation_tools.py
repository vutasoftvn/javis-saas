...
from founder_os.validation.validation_tools import get_snapshot
...
@patch("founder_os.validation.validation_tools.QuestionGraphService")
@patch("founder_os.validation.validation_tools.ProblemIntelligenceService")
@patch("founder_os.validation.validation_tools.ValidationReviewService")
@patch("founder_os.validation.validation_tools.RiskPrioritizationService")
@patch("founder_os.validation.validation_tools.ValidationEngineService")
