import pytest
from integrations.workflows.graph.contracts import WorkflowGraph, GraphNode, GraphEdge, ToolNodeDefinition, ApprovalNodeDefinition
from integrations.workflows.graph.compiler import compile_graph, CompilationResult
