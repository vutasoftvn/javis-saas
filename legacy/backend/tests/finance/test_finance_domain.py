...
from business.finance.domain.accounting_profile_service import activate_profile
from business.finance.domain.management_metrics_service import calculate_management_metrics
from business.finance.domain.period_service import transition_period
from business.finance.regulations.tt58_2026.registry import get_book_templates
