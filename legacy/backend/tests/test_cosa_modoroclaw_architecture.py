...
from workforce.agents.capabilities.base import (
    CapabilityRequest,
    CapabilityResult,
    EvidenceObject,
...
from founder_os.workspace.manager import CompanyWorkspaceManager
from workforce.agents.context.compiler import (
    ProgressiveContextCompiler,
    ContextBudget,
)
from workforce.routing.deterministic import Intent
from workforce.agents.learning.reflection_engine import ReflectionEngine
from integrations.channels.identity_resolver import ChannelIdentityResolver
from workforce.skills.schema import SkillManifest, FailurePolicy
