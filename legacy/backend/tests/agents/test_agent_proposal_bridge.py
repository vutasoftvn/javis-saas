...
from workforce.agents.proposals.command import parse_proposal_command
...
from founder_os.strategy.models import OkrObjective, OkrCycle
...
def test_agent_proposal_service_apply_project_cycle_setup_runs_the_full_pipeline(monkeypatch):
    ...
    from workforce.agents.proposals import service as proposals_service
    from founder_os.strategy.models import MvpStage, Project
    from founder_os.strategy.schemas.project_orchestration_schemas import RoadmapDraft, StagePlanDraft
