...
from workforce.agents.domains.marketing import (
...
def test_marketing_capabilities_standalone():
    ...
    # 1. Data Capability
    with patch("business.marketing.services.funnel_engine.FunnelEngine.build_funnel", return_value={"stages": []}), \
         patch("business.marketing.services.scorecard_service.ScorecardService.build", return_value={"score": 85}):
