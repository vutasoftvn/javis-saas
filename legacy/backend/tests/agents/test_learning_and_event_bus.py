...
from workforce.agents.learning.verifier import Verifier, LearningWriter
...
def test_publish_agent_event_broadcasts_safe_payload(monkeypatch):
    ...
    monkeypatch.setattr("workforce.agents.events.agent_event_bus.publish_event", mock_publish)
