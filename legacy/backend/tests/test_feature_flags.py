...
def test_every_tool_flag_is_declared_in_tool_flag_defaults():
    from core.feature_flags import TOOL_FLAG_DEFAULTS
    ...
    used = {
        ...
        if spec.flag_key and getattr(spec.callable, "__module__", "").startswith("")
    }
...
def test_every_tool_flag_default_is_actually_seeded_by_a_migration():
    ...
    from core.feature_flags import LEGACY_FLAG_ALIASES, TOOL_FLAG_DEFAULTS
