...
in ra đúng danh sách model nhận được, kèm lý do cho từng tool vắng mặt.
    ...
    cd backend && python -m app.scripts.ai_tools_report <workspace_id>
...
from core.feature_flags import TOOL_FLAG_DEFAULTS, is_enabled
from core.tool_bootstrap import load_all_tools
from core.tool_registry import get_registered_tools
from db.session import SessionLocal
from workforce.chat.company_tools import tool_specs
...
def _print_data_sanity(db, workspace_id: int) -> None:
    ...
    from db.models import OkrObjective, Project
