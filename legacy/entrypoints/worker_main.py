...
from workforce.chat.ai_router import AIRouter
from workforce.chat.chat_execution_service import claim_pending_messages, run_turn
from workforce.chat.chat_stream_bus import ChatJobListener, PostgresChatEventPublisher
from workforce.chat.providers import build_provider
from db.models import ChunkingJob, VaultRevision, DocumentChunk
from integrations.storage.s3_client import get_object
from sqlalchemy import text
from datetime import datetime
from founder_os.tasks.scheduler_service import process_due_schedules
from integrations.channels.outbox.channel_worker import channel_worker_loop
from integrations.channels.zalo.zalo_qr_service import process_one_queued_qr_session
from core.worker_health import HEARTBEAT_INTERVAL_SECONDS, record_worker_heartbeat
...
from workforce.agents.orchestration.mission_control_bus import register_default_listeners
from workforce.agents.orchestration.mission_resume_service import MissionResumeJobService
from workforce.agents.delegation.worker import delegation_loop
import uuid
    ...
    try:
        ...
        try:
            ...
            if rev:
                ...
                from platform_core.vault.chunking_service import chunk_markdown
