...
class Blocker(Base):
    ...
    weekly_mission_id: Mapped[Optional[int]] = mapped_column(ForeignKey("operating.weekly_commitments.id"), nullable=True, index=True)
    ...
    resolution_artifact_id: Mapped[Optional[int]] = mapped_column(ForeignKey("runtime_ops.artifacts.id"), nullable=True)
    escalated_to: Mapped[Optional[int]] = mapped_column(ForeignKey("core.users.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class Handoff(Base):
    ...
    source_task_id: Mapped[Optional[int]] = mapped_column(ForeignKey("operating.tasks.id"), nullable=True, index=True)
    target_task_id: Mapped[Optional[int]] = mapped_column(ForeignKey("operating.tasks.id"), nullable=True, index=True)
