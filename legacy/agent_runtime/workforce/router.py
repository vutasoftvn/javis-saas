...
from workforce.chat import router as chat
from workforce.chat import ai_api as ai
from workforce.memory import router as agent_memory
from workforce.skills import router as skills_router
from workforce.ai_team import router as ai_team
from workforce.api.admin_api import router as admin_api
from workforce.automation import router as automation_router
from workforce.agents.router import router as agent_runtime_router
from workforce.agents.execution_router import router as agent_execution_router
from workforce.agents.approvals_router import router as agent_approvals_router
from workforce.agents.proposals.router import router as agent_proposals_router
from workforce.agents.orchestrator.router import router as agent_orchestrator_router
from workforce.agents.orchestration.router import router as mission_control_router
from workforce.runtime_router import router as runtime_router
from workforce.extensions.router import router as extension_router

from workforce.ai.programs.router import router as ai_programs_router
from workforce.api.cofounder_api import router as cofounder_api
from workforce.api.packs_api import router as packs_api
