...
from founder_os.outcomes.models import Artifact, OutcomeRun
...
class RealityVerifier:
    ...
    def verify_email_outbox(
        ...
        from integrations.channels.models import Outbox
    ...
    def verify_accounting_document(
        ...
        from business.finance.models import AccountingDocument
    ...
    def verify_financial_transaction(
        ...
        from business.finance.models import AccountingRecord, FinancialTransaction
