...
from business.finance.finance_tools import get_financial_summary
from business.legal.legal_tools import get_legal_posture_summary
from business.marketing.marketing_tools import get_marketing_overview
from business.sales.sales_tools import get_pipeline_summary
...
def _call_snapshot_fn(name: str, fallback_fn: Callable[[Session, int], dict[str, Any]], db: Session, ws: int) -> dict[str, Any]:
    mod = sys.modules.get("workforce.agents.orchestration.chief_of_staff")
