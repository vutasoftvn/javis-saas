...
**Files sửa:** [weekly-review.service.ts](/services/company/operations/strategy/services/weekly-review.service.ts), [next-best-action.service.ts](/services/company/operations/strategy/services/next-best-action.service.ts), [next-best-action.handler.ts](/services/company/operations/strategy/handlers/next-best-action.handler.ts), [execution-plan.service.ts](/services/company/operations/services/execution-plan.service.ts), [execution-plan.handler.ts](/services/company/operations/handlers/execution-plan.handler.ts), [ai-compliance-governance.service.ts](/services/company/finance-legal/services/ai-compliance-governance.service.ts).

**Files tạo:** [command-authority.service.ts](/services/company/identity/services/command-authority.service.ts), [business-command-authority.test.ts](/services/company/identity/tests/business-command-authority.test.ts), [strategy-command-tenancy.test.ts](/services/company/operations/strategy/tests/strategy-command-tenancy.test.ts).
...
**Files sửa:** [identity.ts](/services/company/shared/db/schema/identity.ts), [schema index](/services/company/shared/db/schema/index.ts), [tenant-context.service.ts](/services/company/identity/services/tenant-context.service.ts), [tenant_context.ts](/services/company/shared/types/tenant_context.ts), command-authority.service.ts từ A1.

**Files tạo:** [permission-catalog.ts](/services/company/identity/services/permission-catalog.ts), [permission-evaluator.ts](/services/company/identity/services/permission-evaluator.ts), [business-authorization.service.ts](/services/company/identity/services/business-authorization.service.ts), [8_business_permissions.up.sql](/services/company/identity/migrations/8_business_permissions.up.sql), [permission-evaluator.test.ts](/services/company/identity/tests/permission-evaluator.test.ts).
...
**Files sửa:** [operations policy schema](/services/company/shared/db/schema/operations.ts), [execution-plan.service.ts](/services/company/operations/services/execution-plan.service.ts), [agent-policy.service.ts](/services/cosa/services/agent-policy.service.ts), [COSA schema](/services/cosa/storage/schema.ts), [evaluator.py](/apps/cosa/policies/evaluator.py), [company_policy_client.py](/apps/cosa/policies/company_policy_client.py), [gateway.py](/packages/agent/capabilities/gateway.py), [delegation service](/services/company/shared/auth/cosa-delegation.service.ts).

**Files tạo:** [business-policy.handler.ts](/services/company/identity/handlers/business-policy.handler.ts), [policy-snapshot.test.ts](/services/company/identity/tests/policy-snapshot.test.ts), [test_business_policy_revocation.py](/tests/apps/cosa/policies/test_business_policy_revocation.py). Migration identity 9_business_policy_sources.up.sql và COSA 31_business_policy_references.up.sql chỉ thêm nguồn/version/hash và cutover marker; không copy raw business facts lên Control Plane.
...
**Files sửa:** [settings_view.dart](/frontend/lib/modules/settings/views/settings_view.dart), [settings_binding.dart](/frontend/lib/modules/settings/bindings/settings_binding.dart), [mvp-surface.json](/shared/contracts/mvp-surface.json), Company identity API barrel.

**Files tạo:** [permissions.handler.ts](/services/company/identity/handlers/permissions.handler.ts), [permissions.service.ts](/services/company/identity/services/permissions.service.ts), [permission_models.dart](/frontend/lib/modules/settings/models/permission_models.dart), [permissions_service.dart](/frontend/lib/modules/settings/services/permissions_service.dart), [permissions_controller.dart](/frontend/lib/modules/settings/controllers/permissions_controller.dart), [permissions_panel.dart](/frontend/lib/modules/settings/views/widgets/permissions_panel.dart), [permissions_panel_test.dart](/frontend/test/modules/settings/permissions_panel_test.dart), [permissions-api.test.ts](/services/company/identity/tests/permissions-api.test.ts).
