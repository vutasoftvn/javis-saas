...
Chưa audit sâu trong phiên Wave 0-11 (không nằm trong phạm vi công việc chính, không có thay đổi nào tới subsystem này trong phiên) — xem `packages/agent_core/artifacts/{distribution.py,lifecycle.py}` trực tiếp cho chi tiết implementation. Cần 1 pass tài liệu hoá riêng theo template đầy đủ nếu cần.
