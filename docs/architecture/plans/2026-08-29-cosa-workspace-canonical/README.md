...
| M4 | [M4-lifecycle.md](./M4-lifecycle.md) | §9.4 | Bắt đầu — ✅ §1 rename `company_stage`→`lifecycle_stage` (W0–W5) + tách `stage_transition_policies`/`workspace_stage_transitions`; API bỏ `companyStage`/`ventureStage` (508/508 encore test). ⏳ §2 CAS, §3 project P0–P6, §4 frontend route/enum, §5 legal status, §6 eligibility |
