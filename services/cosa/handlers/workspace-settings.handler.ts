...
export const listWorkspaceMembers = api(
  { expose: true, method: "GET", path: "/platform/organizations/:workspaceId/members" },
...
export const listWorkspaceConnectors = api(
  { expose: true, method: "GET", path: "/platform/organizations/:workspaceId/connectors" },
...
export const installWorkspaceConnector = api(
  { expose: true, method: "POST", path: "/platform/organizations/:workspaceId/connectors/:connectorKey/install" },
...
export const revokeWorkspaceConnector = api(
  { expose: true, method: "POST", path: "/platform/organizations/:workspaceId/connectors/:connectorKey/revoke" },
  async ({ workspaceId, connectorKey, authorization }: ConnectorActionRequest): Promise<MvpSuccess<ConnectorStatusView>> => {
...
export const listWorkspaceRuntimeNodes = api(
  { expose: true, method: "GET", path: "/platform/organizations/:workspaceId/runtime-nodes" },
...
export const revokeWorkspaceRuntimeNode = api(
  { expose: true, method: "POST", path: "/platform/organizations/:workspaceId/runtime-nodes/:nodeId/revoke" },
...
export const listWorkspaceAuditEvents = api(
  { expose: true, method: "GET", path: "/platform/organizations/:workspaceId/audit-events" },
...
export const listWorkspaceSkillPolicies = api(
  { expose: true, method: "GET", path: "/platform/organizations/:workspaceId/skill-policies" },
...
export const getWorkspaceSessionContext = api(
  { expose: true, method: "GET", path: "/platform/organizations/:workspaceId/session-context" },
...
export const putWorkspaceSkillPolicy = api(
  { expose: true, method: "PUT", path: "/platform/organizations/:workspaceId/skill-policies/:skillKey" },
...
export const listWorkspaceModuleVisibility = api(
  { expose: true, method: "GET", path: "/platform/organizations/:workspaceId/module-visibility" },
...
export const setWorkspaceModuleEnabled = api(
  { expose: true, method: "PUT", path: "/platform/organizations/:workspaceId/module-visibility/:moduleKey" },
...
export const setUserModulePreference = api(
  { expose: true, method: "PUT", path: "/platform/organizations/:workspaceId/module-visibility/:moduleKey/preference" },
...
export const getWorkspaceCapabilityManifest = api(
  { expose: true, method: "GET", path: "/platform/organizations/:workspaceId/capability-manifest" },
...
export const setWorkspaceSurfaceOverride = api(
  { expose: true, method: "PUT", path: "/platform/organizations/:workspaceId/capability-manifest/:surfaceKey" },
