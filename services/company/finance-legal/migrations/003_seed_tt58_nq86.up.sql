-- 003_seed_tt58_nq86.up.sql
-- Startup Core Task-2: restore the TT58/2026 + NQ86 regulation catalog seed
-- (verbatim from pre-clean-slate 14_legal_seed_tt58_nq86.up.sql, deleted in 81461673).
-- 001 finance-legal creates legal.regulation_sources/versions/obligation_templates/
-- applicability_rules but seeds no rows; legal-applicability + accounting tests
-- depend on applicability rule id=301.
