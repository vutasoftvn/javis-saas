...
if (process.env.WORKSPACE_TEST_DATABASE_URL) {
  process.env.WORKSPACE_DATABASE_URL = process.env.WORKSPACE_TEST_DATABASE_URL;
} else if (!process.env.WORKSPACE_DATABASE_URL) {
  process.env.WORKSPACE_DATABASE_URL = "postgresql://workspace_app:change-me-workspace-app@127.0.0.1:5432/javis_workspace_test?sslmode=disable";
}
