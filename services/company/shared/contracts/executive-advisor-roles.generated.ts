...
export const EXECUTIVE_ROLE_CATALOG: Readonly<Record<ExecutiveRoleKey, ExecutiveAdvisorRoleDef>> = Object.freeze({
  ...
  "coo": Object.freeze({"key":"coo","label":"Chief Operating Officer","advisoryRemit":"Operational cadence, process constraints, delivery dependency mapping","requiredProfileKey":"operations","requiredAgentSpec":"cosa.executive.coo","requiredSkillPins":["skillpack:executive/coo-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_OPERATIONS_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "cro": Object.freeze({"key":"cro","label":"Chief Revenue Officer","advisoryRemit":"Revenue pipeline, sales enablement, pricing guardrails, RevOps alignment","requiredProfileKey":"sales","requiredAgentSpec":"cosa.executive.cro","requiredSkillPins":["skillpack:executive/cro-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_SALES_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "cpo": Object.freeze({"key":"cpo","label":"Chief Product Officer","advisoryRemit":"Customer problem validation, product bets, PRD and backlog priority review","requiredProfileKey":"product","requiredAgentSpec":"cosa.executive.cpo","requiredSkillPins":["skillpack:executive/cpo-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_PRODUCT_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "cco": Object.freeze({"key":"cco","label":"Chief Customer Officer","advisoryRemit":"Customer retention, lifecycle health, support pattern learning","requiredProfileKey":"customer_support","requiredAgentSpec":"cosa.executive.cco","requiredSkillPins":["skillpack:executive/cco-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_CUSTOMER_SUPPORT_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "chro": Object.freeze({"key":"chro","label":"Chief Human Resources Officer","advisoryRemit":"Organizational design, hiring process evaluation, team and people risk","requiredProfileKey":"people","requiredAgentSpec":"cosa.executive.chro","requiredSkillPins":["skillpack:executive/chro-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_PEOPLE_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "ciso": Object.freeze({"key":"ciso","label":"Chief Information Security Officer","advisoryRemit":"Security threat modeling, privacy controls, compliance gap assessment","requiredProfileKey":"security","requiredAgentSpec":"cosa.executive.ciso","requiredSkillPins":["skillpack:executive/ciso-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_SECURITY_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "gc": Object.freeze({"key":"gc","label":"General Counsel","advisoryRemit":"Legal and regulatory issue spotting, policy risk resolution, escalation","requiredProfileKey":"legal","requiredAgentSpec":"cosa.executive.gc","requiredSkillPins":["skillpack:executive/gc-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_LEGAL_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "cdo": Object.freeze({"key":"cdo","label":"Chief Data Officer","advisoryRemit":"Data governance, quality, rights management, scoped knowledge integrity","requiredProfileKey":"data","requiredAgentSpec":"cosa.executive.cdo","requiredSkillPins":["skillpack:executive/cdo-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_DATA_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "caio": Object.freeze({"key":"caio","label":"Chief AI Officer","advisoryRemit":"Model evaluation, provider governance, prompt safety, red-team assessment","requiredProfileKey":"ai_governance","requiredAgentSpec":"cosa.executive.caio","requiredSkillPins":["skillpack:executive/caio-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_AI_GOVERNANCE_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
  "vpe": Object.freeze({"key":"vpe","label":"VP Engineering","advisoryRemit":"Technical feasibility, architecture constraints, release readiness, delivery risks","requiredProfileKey":"coding","requiredAgentSpec":"cosa.executive.vpe","requiredSkillPins":["skillpack:executive/vpe-advisor@1.0.0"],"advisoryOnly":true,"runtimeReadiness":"PENDING_ENGINEERING_PROFILE","sourceProvenance":"superpowers:executive-advisory-board"}),
});

export const STARTUP_CORE_PRESETS: Readonly<Record<StartupCorePresetKey, StartupCorePresetDef>> = Object.freeze({
  "startup-discovery": Object.freeze({"key":"startup-discovery","label":"Startup Discovery Core","description":"Giữ focus quyết định, kiểm chứng nhu cầu/thông điệp và kiểm soát runway sớm.","defaultRoleKeys":["chief_of_staff","cmo","cfo"]}),
  "startup-build-launch": Object.freeze({"key":"startup-build-launch","label":"Startup Build & Launch Core","description":"Bổ sung điều phối vận hành khi Founder đã chủ động vào giai đoạn build/launch.","defaultRoleKeys":["chief_of_staff","cmo","cfo","coo"]}),
});
