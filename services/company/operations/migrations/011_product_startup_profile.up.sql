-- Migration 011: Backfill product profile to Project Startup Team
-- Bổ sung product profile dưới dạng TEMPLATE cho các Project hiện có chưa có product profile.
...
SELECT
  ...
  jsonb_build_object(
    'profileKey', 'product',
    'source', 'product_profile_catalog_backfill_v1'
  )
