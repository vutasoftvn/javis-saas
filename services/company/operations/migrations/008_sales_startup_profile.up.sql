-- Migration 008: Backfill sales profile to Project Startup Team
-- Bổ sung sales profile dưới dạng TEMPLATE cho các Project hiện có chưa có sales profile.
...
SELECT
  ...
  jsonb_build_object(
    'profileKey', 'sales',
    'source', 'sales_profile_catalog_backfill_v1'
  )
