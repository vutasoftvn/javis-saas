-- Migration 007: Backfill operations profile to Project Startup Team
-- Bổ sung operations profile dưới dạng TEMPLATE cho các Project hiện có chưa có operations profile.
...
DROP SEQUENCE IF EXISTS operating.temp_assignment_event_id_seq;
