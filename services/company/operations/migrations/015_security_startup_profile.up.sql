-- Migration 015: Backfill security profile to Project Startup Team
-- Bổ sung security profile dưới dạng TEMPLATE cho các Project hiện có chưa có security profile.
...
SELECT
  ...
  jsonb_build_object(
    'profileKey', 'security',
    'source', 'security_profile_catalog_backfill_v1'
  )
