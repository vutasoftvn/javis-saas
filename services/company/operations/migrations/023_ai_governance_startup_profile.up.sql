-- Migration 023: Backfill ai_governance profile to Project Startup Team
-- Bổ sung ai_governance profile dưới dạng TEMPLATE cho các Project hiện có chưa có ai_governance profile.
...
SELECT
  ...
  jsonb_build_object(
    ...
    'source', 'ai_governance_profile_catalog_backfill_v1'
  )
