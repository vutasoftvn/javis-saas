-- Migration 009: Backfill coding profile to Project Startup Team
-- Bổ sung coding profile dưới dạng TEMPLATE cho các Project hiện có chưa có coding profile.
...
SELECT
  ...
  jsonb_build_object(
    'profileKey', 'coding',
    'source', 'coding_profile_catalog_backfill_v1'
  )
