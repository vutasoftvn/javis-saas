-- Migration 021: Backfill data profile to Project Startup Team
-- Bổ sung data profile dưới dạng TEMPLATE cho các Project hiện có chưa có data profile.
...
SELECT
  ...
  jsonb_build_object(
    'profileKey', 'data',
    'source', 'data_profile_catalog_backfill_v1'
  )
