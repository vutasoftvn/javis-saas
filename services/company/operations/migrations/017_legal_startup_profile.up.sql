-- Migration 017: Backfill legal profile to Project Startup Team
-- Bổ sung legal profile dưới dạng TEMPLATE cho các Project hiện có chưa có legal profile.
...
SELECT
  ...
  jsonb_build_object(
    'profileKey', 'legal',
    'source', 'legal_profile_catalog_backfill_v1'
  )
