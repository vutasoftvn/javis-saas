...
from integrations.channels.models import Outbox, Chatbot, EmailApproval
from integrations.channels.telegram.telegram_adapter import send_telegram_message
from integrations.channels.zalo.zalo_adapter import send_zalo_oa_message
    ...
    try:
        if channel == "telegram":
            ...
            if provider_name == "resend":
                from integrations.channels.email.providers.resend_provider import build_resend_client
                ...
                from integrations.channels.google.google_connection_service import build_gmail_client
