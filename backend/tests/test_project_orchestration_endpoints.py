...
from founder_os.strategy.routers.project_orchestration_router import (
    confirm_mvp_roadmap,
    get_mvp_roadmap,
    list_project_stages,
...
def test_save_mvp_roadmap_draft_endpoint_serializes_stages():
    ...
    with patch("founder_os.strategy.routers.project_orchestration_router._service") as mock_service_factory:
