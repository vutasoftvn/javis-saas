...
_MODULE = "founder_os.strategy.routing_service"
...
def test_confirm_assessment_rejects_autonomous_override_for_regulated_capability():
    from founder_os.strategy.routing_service import RoutingService
    from founder_os.strategy.schemas.project_orchestration_schemas import ServiceAssessmentDecision
...
def test_confirm_assessment_accepts_approved_manual_execution_and_creates_assignment():
    from founder_os.strategy.models import StageAssignment, StageServiceAssessment
    from founder_os.strategy.routing_service import RoutingService
    from founder_os.strategy.schemas.project_orchestration_schemas import ServiceAssessmentDecision
...
def test_confirm_assessment_rejected_decision_creates_no_assignment():
    from founder_os.strategy.models import StageAssignment
    from founder_os.strategy.routing_service import RoutingService
    from founder_os.strategy.schemas.project_orchestration_schemas import ServiceAssessmentDecision
