...
from integrations.channels.google import google_connection_service as service
from integrations.channels.google.google_connection_service import GoogleNotConnected
