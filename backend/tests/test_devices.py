...
from integrations.devices.models import Device, DeviceCredential, DeveloperJob, JobLease
from integrations.devices import service
from integrations.devices.router import (
    enroll_new_device,
...
from core.auth import get_current_device
