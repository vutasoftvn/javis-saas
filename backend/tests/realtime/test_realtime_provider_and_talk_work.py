...
import pytest
from integrations.realtime.provider import LiveKitRealtimeProvider, RealtimeProvider
from platform_core.license.talk_work_router import TalkWorkRouter, TalkWorkMode
...
def test_livekit_realtime_provider_transport_and_token():
    ...
    with patch("integrations.realtime.provider.generate_livekit_token", return_value="mock_jwt_token_123"):
