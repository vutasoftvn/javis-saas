...
from business.sales.models import Account, Contact, SalesLead, SalesOpportunity
from business.marketing.models import MarketingContext, MarketingCampaign, PendingApproval
from integrations.channels.models import EmailApproval
from business.sales.revenue_engine_service import (
    get_icp_context,
    update_icp_context,
    list_campaigns,
    create_campaign,
...
from business.sales.revenue_router import (
    get_icp,
    update_icp,
    UpdateICPRequest,
    get_pipeline,
...
from business.sales.public_lead_router import (
    submit_public_lead,
...
async def test_sales_action_default_is_approved_fails_closed_through_governance():
    ...
    with patch(
        "workforce.agents.domains.sales.action.dispatch_outbound_action",
...
def test_sales_reality_verifier_crm_lead_success():
    ...
    from workforce.agents.verification.reality_verifier import RealityVerifier, VerificationVerdict
...
def test_end_to_end_revenue_engine_flow():
    ...
    from business.sales.revenue_engine_service import execute_prospect_to_qualified_lead_pipeline
