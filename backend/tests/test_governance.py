...
from db.models import WorkspaceMember, WorkflowRun, WorkflowStep, WorkflowApproval, AuditLog, WorkflowDefinition, Brain
from core.audit import write_audit_log
from platform_core.core.router import list_audit_events
from integrations.workflows.router import (
...
def test_approve_and_reject_workflow_step_with_audit(monkeypatch):
    ...
    monkeypatch.setattr("integrations.workflows.router.resolve_workflow_run_workspace_id", lambda db, run: ws_id)
