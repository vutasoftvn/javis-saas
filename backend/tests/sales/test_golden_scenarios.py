...
@patch("business.sales.domain.leads.HandoffService.accept_handoff")
def test_golden_scenario_a_marketing_intake_dedupe(mock_accept):
    ...
    with patch("business.sales.domain.leads.ContactService.create_contact") as mock_contact, \
         patch("business.sales.domain.leads.AccountService.create_account") as mock_acc, \
         patch("business.sales.domain.leads.LeadService.create_lead") as mock_lead:
