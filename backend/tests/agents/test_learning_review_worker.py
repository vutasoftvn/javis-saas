...
from workforce.skills.models import SkillTrajectoryCandidate
...
def _patched(db: Session):
    ...
    return patch("workforce.agents.learning.review_worker.SessionLocal", return_value=_NoCloseSession(db))
