...
from founder_os.outcomes.models import RunEvent, RunStep
from integrations.devices.models import DeveloperJob, JobLease


def test_phase_c_persistence_contract_is_registered():
    """Removing any durable correlation field breaks restart-safe delegation."""
    assert importlib.util.find_spec("workforce.agents.delegation.models") is not None
