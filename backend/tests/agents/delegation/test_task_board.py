...
from founder_os.outcomes.models import Outcome, OutcomeRun, RunEvent, RunStep
...
async def test_assign_step_waits_for_dependencies(monkeypatch):
    from workforce.agents.delegation.task_board import DependencyNotReady
...
async def test_assign_step_fails_closed_for_workspace_and_kill_switch(monkeypatch):
    from workforce.agents.delegation.task_board import (
        DelegationDisabled,
