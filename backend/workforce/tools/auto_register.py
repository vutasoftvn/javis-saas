...
from workforce.tools.finance.tools import (
    finance_read_summary_handler,
    finance_post_entry_handler,
)
from workforce.tools.sales.tools import (
    crm_search_handler,
    crm_update_handler,
    email_send_handler,
)
from workforce.tools.project.tools import (
    project_read_portfolio_handler,
    okr_read_overview_handler,
    strategy_read_canvas_handler,
)
from workforce.tools.knowledge.tools import (
    knowledge_search_handler,
    system_help_handler,
)
from workforce.tools.marketing.tools import (
