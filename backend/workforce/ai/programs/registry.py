...
from workforce.ai.programs.ceo_brief.program import CEOBriefProgram
from workforce.ai.programs.sales.lead_qualification import LeadQualificationProgram
    ...
    def initialize_default_programs(cls) -> None:
        ...
        cls.register(
            ...
            meta=ProgramRegistration(
                ...
                program_class_path="workforce.ai.programs.ceo_brief.program.CEOBriefProgram",
        ...
        cls.register(
            ...
            meta=ProgramRegistration(
                ...
                program_class_path="workforce.ai.programs.sales.lead_qualification.LeadQualificationProgram",
                default_version="1.0.0",
                fallback_mode="legacy",
            ),
        )
