...
from workforce.models import FounderDecision, AgentDefinition, ApprovalRequest
from workforce.schemas.decision_schemas import DecisionStatusEnum, DecisionDomainEnum
from workforce.agents.governance.models import AgentRun
...
class CosaCofounderService:
    ...
    async def get_company_pulse(
        ...
        from founder_os.strategy.models import Project, TwelveWeekCycle
