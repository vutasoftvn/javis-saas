...
from app.modules.platform.models import WorkspaceDomain
from app.modules.sales.domain.contacts import ContactService
from app.modules.sales.domain.leads import LeadService
from app.modules.sales.domain.accounts import AccountService
...
async def get_site_navigation(
    ...
    """
    from app.modules.platform.models import NavigationGroup, NavigationItem
