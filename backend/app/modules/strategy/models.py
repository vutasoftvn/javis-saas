...
class StrategyRevision(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    canvas_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("strategy_canvases.id"), index=True)
    ...
    parent_revision_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("strategy_revisions.id", use_alter=True), nullable=True)
...
class StrategyFoundation(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    strategy_revision_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("strategy_revisions.id"), unique=True, index=True)
...
class CoreValue(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    foundation_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("strategy_foundations.id", ondelete="CASCADE"), index=True)
...
class ContextPack(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    strategy_revision_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("strategy_revisions.id"), nullable=True, index=True)
...
class ContextPackSource(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    context_pack_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("context_packs.id"), index=True)
    ...
    revision_id: Mapped[Optional[uuid.UUID]] = mapped_column(nullable=True, index=True)
    evidence_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("evidence_items.id"), nullable=True, index=True)
    source_type: Mapped[str] = mapped_column(String(50))
    citation_jsonb: Mapped[Optional[dict]] = mapped_column(JSONB, nullable=True)
    included_by: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("users.id"), nullable=True)

class StrategyAnalysis(Base):
    __tablename__ = "strategy_analyses"
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    portfolio_id: Mapped[Optional[uuid.UUID]] = mapped_column(nullable=True, index=True)
    context_pack_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("context_packs.id"), index=True)
    ...
    output_revision_id: Mapped[Optional[uuid.UUID]] = mapped_column(nullable=True)
    created_by: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("users.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class PestelItem(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    portfolio_id: Mapped[Optional[uuid.UUID]] = mapped_column(nullable=True, index=True)
    analysis_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("strategy_analyses.id"), index=True)
...
class StrategicDecision(Base):
    ...
    brain_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("brains.id"), index=True)
    context_pack_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("context_packs.id"), index=True)
    tows_option_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("tows_options.id"), nullable=True)
    decision: Mapped[str] = mapped_column(Text)
    rationale_revision_id: Mapped[Optional[uuid.UUID]] = mapped_column(nullable=True)
    status: Mapped[str] = mapped_column(String(50), default="draft")
...
class MetricCheckin(Base):
    ...
    entered_by: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("users.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class BscScorecard(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    strategy_profile_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("strategy_canvases.id"), index=True)
...
class StrategicObjective(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    scorecard_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("bsc_scorecards.id"), index=True)
    ...
    status: Mapped[str] = mapped_column(String(50), default="draft")
    metric_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("metrics.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class StrategicObjectiveLink(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    from_objective_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("strategic_objectives.id"), index=True)
    to_objective_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("strategic_objectives.id"), index=True)
...
class OkrObjective(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    cycle_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("okr_cycles.id"), index=True)
    strategic_objective_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("strategic_objectives.id"), nullable=True)
    title: Mapped[str] = mapped_column(String(255))
    owner_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("users.id"), nullable=True)
    status: Mapped[str] = mapped_column(String(50), default="draft")
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class KeyResult(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    objective_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("okr_objectives.id"), index=True)
...
class OkrLink(Base):
    ...
    from_entity_id: Mapped[uuid.UUID] = mapped_column(index=True)
    to_entity_type: Mapped[str] = mapped_column(String(50))
    to_entity_id: Mapped[uuid.UUID] = mapped_column(index=True)
    relation_type: Mapped[str] = mapped_column(String(50))
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class InitiativeKeyResultLink(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    initiative_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("initiatives.id"), index=True)
    key_result_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("key_results.id"), index=True)
...
class TwelveWeekCycle(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    brain_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("brains.id"), index=True)
    okr_cycle_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("okr_cycles.id"), nullable=True)
    cycle_contract_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("cycle_contracts.id", use_alter=True), nullable=True, index=True)
...
class WeeklyPlan(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    cycle_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("twelve_week_cycles.id"), index=True)
    stage_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("cycle_stages.id"), nullable=True, index=True)
...
class WeeklyCommitment(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    weekly_plan_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("weekly_plans.id"), index=True)
...
class ProjectClassification(Base):
    ...
    classified_by: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("users.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
...
class CycleContract(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    cycle_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("twelve_week_cycles.id", ondelete="CASCADE"), unique=True, index=True)
...
class CycleStage(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    cycle_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("twelve_week_cycles.id", ondelete="CASCADE"), index=True)
...
class Milestone(Base):
    ...
    cycle_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("twelve_week_cycles.id", ondelete="CASCADE"), nullable=True, index=True)
    stage_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("cycle_stages.id", ondelete="SET NULL"), nullable=True, index=True)
    name: Mapped[str] = mapped_column(String(255))
    description: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
...
class MilestoneEvidence(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    milestone_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("milestones.id", ondelete="CASCADE"), index=True)
...
class GateDecision(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    project_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), index=True)
    milestone_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("milestones.id", ondelete="SET NULL"), nullable=True, index=True)
    stage_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("cycle_stages.id", ondelete="SET NULL"), nullable=True, index=True)
...
class AnalysisImport(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    project_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), nullable=True, index=True)
    strategy_revision_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("strategy_revisions.id", ondelete="SET NULL"), nullable=True, index=True)
    raw_input: Mapped[str] = mapped_column(Text)
    parsed_json: Mapped[dict] = mapped_column(JSONB)
    schema_version: Mapped[str] = mapped_column(String(50), default="1.0")
    imported_by: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("users.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class PromptTemplate(Base):
    ...
    brain_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("brains.id"), nullable=True, index=True)
...
class ProjectPestelImpact(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    project_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), index=True)
    pestel_item_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("pestel_items.id", ondelete="CASCADE"), index=True)
...
class PortfolioSynergy(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    portfolio_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("portfolios.id", ondelete="CASCADE"), index=True)
    source_project_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), index=True)
    target_project_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), index=True)
...
class PortfolioDependency(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    portfolio_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("portfolios.id", ondelete="CASCADE"), index=True)
    predecessor_project_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), index=True)
    successor_project_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), index=True)
...
class PortfolioOption(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    portfolio_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("portfolios.id", ondelete="CASCADE"), index=True)
    tows_option_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("tows_options.id", ondelete="SET NULL"), nullable=True)
    title: Mapped[str] = mapped_column(String(255))
    description: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
...
class CapacityAllocation(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    portfolio_cycle_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("portfolio_cycles.id", ondelete="CASCADE"), index=True)
    project_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), index=True)
...
class NextActionCandidate(Base):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    project_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("projects.id", ondelete="CASCADE"), nullable=True, index=True)
    portfolio_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("portfolios.id", ondelete="CASCADE"), nullable=True, index=True)
    title: Mapped[str] = mapped_column(String(255))
    description: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
...
class NextActionRanking(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True, default=uuid.uuid4)
    workspace_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("workspaces.id"), index=True)
    candidate_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("next_action_candidates.id", ondelete="CASCADE"), index=True)
