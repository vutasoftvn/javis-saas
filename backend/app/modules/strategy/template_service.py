...
from app.modules.strategy.models import CapabilityDefinition, WorkspaceTemplate, WorkspaceTemplateVersion
from app.modules.strategy.seed_templates import SEED_TEMPLATES, SEED_TEMPLATES_BY_KEY
