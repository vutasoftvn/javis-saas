...
from app.integrations.channels.models import EmailApproval, Outbox
...
def execute_prospect_to_qualified_lead_pipeline(
    ...
    """
    from app.workforce.agents.domains.sales.reasoning import SalesReasoningCapability
    from app.workforce.agents.verification.reality_verifier import RealityVerifier
