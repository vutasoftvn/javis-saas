...
from app.workforce.composition.contracts import ProfileExplanation, ResolvedProfile
...
from app.workforce.extensions.tool_registration import extension_tool_spec
