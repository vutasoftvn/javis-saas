...
from app.founder_os.strategy.schemas import (
    ObjectiveCreate,
    CanvasCreate,
    CanvasUpdate,
    RevisionCreate,
...
from app.founder_os.strategy.routers.analysis_router import (
    router as analysis_router,
    create_decision,
    list_decisions,
    _serialize_decision,
)
from app.founder_os.strategy.routers.project_orchestration_router import router as project_orchestration_router
from app.founder_os.strategy.routers.template_router import router as template_router
