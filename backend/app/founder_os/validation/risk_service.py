...
class RiskPrioritizationService:
    ...
    def detect_solution_bias_risk(
        ...
        """
        from app.founder_os.validation.models import DimensionState, DimensionName, DimensionStateEnum
        from app.founder_os.validation.schemas import SolutionBiasRiskResponse
