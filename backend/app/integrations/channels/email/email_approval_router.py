...
from app.integrations.channels.email.gmail_client import GmailError
...
async def approve_email(
    ...
    if approval.provider == "resend":
        try:
            from app.integrations.channels.email.providers.resend_provider import build_resend_client, ResendError
