...
from app.integrations.channels.outbox import outbox_processor
from app.integrations.channels.telegram import telegram_adapter
from app.integrations.channels.zalo import zalo_adapter
from app.integrations.workflows import n8n_gateway_service
