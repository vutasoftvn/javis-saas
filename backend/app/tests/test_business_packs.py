...
from app.business.packs.resolver import BusinessPackResolver
from app.business.packs.legal_resolver import LegalKnowledgeResolver
from app.business.packs.service import BusinessPackService
from app.business.packs.models import BusinessAssetOverrideModel, LegalAnnotationRecord
from app.business.packs.schemas import TemplateBundle, CapabilityDefinition, SOPDefinition
...
async def test_update_engine_check_and_conflict_detection():
    from app.business.packs.update_engine import PackUpdateEngine
