...
def setup_portfolio_projects(app):
    ...
    from core.strategy.project import Project
    ...
    from app.founder_os.strategy.models import Portfolio, PortfolioProject
...
def test_portfolio_projects_list_filters_by_offering(client, app, owner_auth, monkeypatch):
    monkeypatch.setattr("app.founder_os.strategy.portfolio_router.require_flag", lambda *args, **kwargs: True)
