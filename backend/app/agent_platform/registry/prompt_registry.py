...
from app.agent_platform.models import PlatformPromptTemplate, PlatformPromptVersion
from app.agent_platform.registry.defaults import DEFAULT_PROMPT_TEMPLATES
