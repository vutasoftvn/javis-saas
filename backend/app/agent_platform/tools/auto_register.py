...
from app.agent_platform.tools.finance.tools import (
    finance_read_summary_handler,
    finance_post_entry_handler,
)
from app.agent_platform.tools.sales.tools import (
    crm_search_handler,
    crm_update_handler,
    email_send_handler,
)
from app.agent_platform.tools.project.tools import (
    project_read_portfolio_handler,
    okr_read_overview_handler,
    strategy_read_canvas_handler,
)
from app.agent_platform.tools.knowledge.tools import (
    knowledge_search_handler,
    system_help_handler,
)
from app.agent_platform.tools.marketing.tools import (
...
from app.agent_platform.tools.developer.tools import (
    developer_build_spec_create_handler,
    developer_claude_code_handler,
    sandbox_execute_handler,
)
from app.agent_platform.tools.tasks.tools import (
    tasks_list_handler,
    tasks_create_handler,
    tasks_update_status_handler,
)
from app.agent_platform.tools.legal.tools import (
    legal_compliance_check_handler,
    legal_obligation_list_handler,
)
from app.agent_platform.tools.company_runtime.tools import (
