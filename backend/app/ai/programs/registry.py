    ...
    def initialize_default_programs(cls) -> None:
        ...
        cls.register(
            ...
            meta=ProgramRegistration(
                ...
                program_class_path="app.ai.programs.ceo_brief.program.CEOBriefProgram",
        ...
        cls.register(
            ...
            meta=ProgramRegistration(
                ...
                program_class_path="app.ai.programs.sales.lead_qualification.LeadQualificationProgram",
                default_version="1.0.0",
                fallback_mode="legacy",
            ),
        )
