...
from core.auth import get_current_workspace_member, get_current_user
from db.models import Attachment, User, WorkspaceMember, Brain
from db.repositories.vault_repo import VaultRepository
from integrations.storage.s3_client import get_object, generate_presigned_download_url, generate_presigned_upload_url
...
def list_vault_documents(
    ...
    from db.models import VaultDocument, Project
...
def read_vault_document(
    ...
    from db.models import VaultRevision
