...
from founder_os.strategy import router as strategy
from founder_os.strategy import okrs_router as okrs
from founder_os.strategy import execution_router as execution
from founder_os.strategy import portfolio_router as portfolios
from founder_os.strategy import next_action_router as next_actions
from founder_os.tasks import router as tasks
from founder_os.tasks import agents_router as agents
from founder_os.outcomes.router import router as outcomes_router
from founder_os.workspace.router import router as workspace_router
from founder_os.validation.router import router as validation_router
