...
from core.rate_limiter import public_rate_limiter
from business.marketing.form_models import FormDefinition, FormSubmission, WebEvent
from platform_core.core.models import WorkspaceDomain
...
async def get_site_navigation(
    ...
    """
    from platform_core.core.models import NavigationGroup, NavigationItem
