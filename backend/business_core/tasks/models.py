...
class Task(Base):
    ...
    assignee_id: Mapped[Optional[int]] = mapped_column(ForeignKey("core.users.id"), nullable=True)
    ...
    assignee_member_id: Mapped[Optional[int]] = mapped_column(ForeignKey("core.workforce_members.id"), nullable=True)
    owner_member_id: Mapped[Optional[int]] = mapped_column(ForeignKey("core.workforce_members.id"), nullable=True)
...
class TaskDependency(Base):
    ...
    depends_on_task_id: Mapped[int] = mapped_column(ForeignKey("operating.tasks.id"), index=True)
