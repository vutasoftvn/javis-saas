...
def test_packages_agent_has_zero_imports_from_services_or_apps():
    """Boundary Audit: Đảm bảo packages/agent hoàn toàn độc lập,
    0 import từ services/* và 0 import từ apps/*.
    """
    agent_dir = Path(__file__).parents[3] / "packages" / "agent"
