...
from agent.contracts.identity import InvocationIdentity, PinnedSkillRef, PinnedSpecIdentity, SpecResolutionManifest
...
def test_contracts_init_exports_same_class_as_target_module():
    """Xác nhận rằng ExecutionTargetSnapshot được export từ agent.contracts
    là cùng class với agent.contracts.target.ExecutionTargetSnapshot.
    """
