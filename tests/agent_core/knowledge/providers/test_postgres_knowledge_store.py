...
AGENT_CORE_TEST_DATABASE_URL (skip nếu không set, giống test_postgres_store.py
...
def test_postgres_knowledge_store_requires_session_factory():
    from agent_core.knowledge.providers.postgres import ConfigurationError, PostgresKnowledgeStore
