            ...
            Row(
              ...
              children: [
                Column(
                  ...
                  children: const [
                    Text(
                      'Tổ chức & Nhân sự Hỗn hợp (Hybrid Workforce)',
                      style: TextStyle(
                        fontSize: 22,
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Trung tâm Điều hành CEO (Command Center) & Quản trị Lực lượng Nhân sự AI kết hợp Con người.',
                      style: TextStyle(
                        fontSize: 13,
                ...
                Row(
                  children: [
                    ElevatedButton.icon(
                      ...
                      label: const Text('Tuyển dụng AI', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
