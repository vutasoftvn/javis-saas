...
class FinanceController extends GetxController {
  ...
  Future<void> load() async {
    final values = await Future.wait([service.getOverview(), service.getTransactions(), service.getDocuments(), service.getBooks(), service.getReports(), service.getPeriods(), service.getExceptions(), service.getProfile()]);
    ...
    books.assignAll(values[3] as List<dynamic>); reports.assignAll(values[4] as List<dynamic>);
    periods.assignAll(values[5] as List<dynamic>); exceptions.assignAll(values[6] as List<dynamic>);
