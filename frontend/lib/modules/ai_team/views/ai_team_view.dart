...
class AiTeamView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        JavisFloatingAppBar(
          title: 'Tổng quan Đội ngũ AI',
          subtitle: 'Giám sát hoạt động và tiến độ các chức năng AI trong doanh nghiệp',
        ...
        Expanded(
          child: Obx(() {
            if (controller.loading.value && controller.functions.isEmpty) {
